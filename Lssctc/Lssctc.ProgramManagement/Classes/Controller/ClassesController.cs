...
namespace Lssctc.ProgramManagement.Classes.Controller
{
    ...
    public class ClassesController : ControllerBase
    {
        ...
        {
            var result = await _classService.GetInstructorByClassIdAsync(classId);
            if (result == null)
        ...
        {
            var result = await _classService.GetTrainingProgressByClassMemberAsync(memberId);
            if (result == null || !result.Any())
        ...
        public async Task<IActionResult> AddTrainingProgress([FromBody] CreateTrainingProgressDto dto)
        {
            ...
            var result = await _classService.AddTrainingProgressAsync(dto);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> UpdateTrainingProgress([FromBody] UpdateTrainingProgressDto dto)
        {
            ...
            var result = await _classService.UpdateTrainingProgressAsync(dto);
            return Ok(result);
        }
        ...
        {
            var result = await _classService.GetTrainingResultsByProgressAsync(progressId);
            if (result == null || !result.Any())
        ...
        public async Task<IActionResult> AddTrainingResult([FromBody] CreateTrainingResultDto dto)
        {
            ...
            var result = await _classService.AddTrainingResultAsync(dto);
            return Ok(result);
        }
        ...
        public async Task<IActionResult> UpdateTrainingResult([FromBody] UpdateTrainingResultDto dto)
        {
            ...
            var result = await _classService.UpdateTrainingResultAsync(dto);
            return Ok(result);
        }
