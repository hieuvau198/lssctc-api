...
namespace Lssctc.ProgramManagement.Quizzes.DTOs
{
    ...
    /// <summary>
    /// DTO to update a complete Quiz with all Questions and Options in one request.
    /// Similar to CreateQuizWithQuestionsDto but for updating existing quiz.
    /// 
    /// IMPORTANT NOTES:
    /// 1. Each question MUST have QuestionScore (0.01 - 9.99)
    /// 2. Total of all question scores MUST equal 10
    /// 3. Each question MUST have 2-20 options
    /// 4. Each question MUST have at least 1 correct option
    /// 5. Single choice questions can only have 1 correct option
    /// 6. OptionScore is AUTO-CALCULATED - DO NOT provide it in JSON
    ...
    /// <summary>
    /// DTO for updating a quiz question with its options.
    /// </summary>
    ...
    /// <summary>
    /// DTO for updating quiz question options (without ID, as options will be replaced).
    /// </summary>
